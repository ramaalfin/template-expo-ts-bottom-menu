...
export default function SpesialRatePemutusScreen() {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#F48120" }}>
      {/* Header */}
      <Topbar titleBar="Special Rate Pemutus" />
      {/* header */}
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          <View style={styles.specialRateContainer}>
            ...
            <View style={{ flexDirection: "row", justifyContent: "flex-end" }}>
              ...
              // onPress={() => navigation.push('/(special-rate-pemutus)/detail/1' as Href<'/(special-rate-pemutus)/detail/1'>)}
              >
      ...
      <TouchableOpacity
        onPress={() => navigation.push(
          `/(special-rate-pemutus)/add` as Href<"/(special-rate-pemutus)/add">
        )}
